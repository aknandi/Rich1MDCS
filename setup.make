...
x86_64-slc5-gcc46-opt (from CMTCONFIG)
LOCAL (from CMTSITE)
Brunel_v44r5_no_config (from PROJECT) excludes [Brunel_v44r5_config]
Brunel_v44r5_root (from PROJECT) excludes [Brunel_v44r5_no_root]
Brunel_v44r5_cleanup (from PROJECT) excludes [Brunel_v44r5_no_cleanup]
Brunel_v44r5_prototypes (from PROJECT) excludes [Brunel_v44r5_no_prototypes]
Brunel_v44r5_with_installarea (from PROJECT) excludes [Brunel_v44r5_without_installarea]
Brunel_v44r5_without_version_directory (from PROJECT) excludes [Brunel_v44r5_with_version_directory]
Brunel_v44r5 (from PROJECT)
...
slc57 (from package CMT)
gcc463 (from package CMT)
Unix (from package CMT) excludes [WIN32 Win32]
----------> CMTPATH
# Add path /home/dhill/cmtuser/Brunel_v44r5 from initialization
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/BRUNEL/BRUNEL_v44r5 from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/REC/REC_v15r0 from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/LBCOM/LBCOM_v14r0 from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/LHCB/LHCB_v36r0 from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/GAUDI/GAUDI_v23r8 from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/DBASE from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lhcb/PARAM from ProjectPath
# Add path /cvmfs/lhcb.cern.ch/lib/lcg/app/releases/LCGCMT/LCGCMT_65 from ProjectPath
